...
image-path: /assets/img/test/정보처리기사-실기-기출-정리-(3)
image:
  path: /assets/img/test/정보처리기사-실기-기출-정리-(3)/q-net.png
...
18. 다음은 프로세스 상태 전이도이다. 괄호(① ~ ③)에 들어갈 알맞은 상태를 쓰시오.
	...
	<img src="/assets/img/test/정보처리기사-실기-기출-정리-(3)/0.png" alt="image-0" class="normal">
