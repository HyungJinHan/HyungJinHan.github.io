...
image:
  path: /assets/img/design-pattern/refactoring-guru/proxy.png
...
![proxy](/assets/img/design-pattern/structure/proxy.png)
...
![proxy_remote](/assets/img/design-pattern/example/proxy_remote.png)
...
- `HTTP Proxy`
  ...
  ![proxy_caching](/assets/img/design-pattern/example/proxy_caching.png)
